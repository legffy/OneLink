...
export default function Home() {
  ...
  const buildings = [
  { name: "Darrin Communications Center", slug: "darrin-communications-center" , seats: 550, image: "darrin.png", abbreviation: "DCC"},
  { name: "Low Center", slug: "low-center", seats: 550, image: "low.jpg", abbreviation: "LOW"},
  { name: "Russell Sage Laboratory", slug: "russell-sage-laboratory", seats: 550, image: "sage_lab.jpg", abbreviation: "SAGE LABORATORY" },
  { name: "Pittsburgh Building", slug: "pittsburgh-building", seats: 550, image: "pittsburgh.jpg", abbreviation: "PITTSBURGH"},
  { name: "Folsom Library", slug: "folsom-library", seats: 900, image: "folsom_library.jpg", abbreviation: "FOLSOM"}
  ];
